...
## Le DAG
Le fichier [`mon_premier_dag_etl.py`](mon_premier_dag_etl.py) définit un DAG `mon_premier_dag_etl` composé de **3 tâches** enchaînées :
```
